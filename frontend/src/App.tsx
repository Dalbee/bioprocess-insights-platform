...
import { Activity, AlertCircle, Droplets, Thermometer, Wind, CheckCircle, Download, Settings, UserCheck, History, Zap, Monitor, X } from 'lucide-react';
  ...
  return (
    <div style={{ 
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
          ...
          */}
          ...
          <button onClick={handleExport} style={btnStyle}><Download size={18} /> Export CSV</button>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '15px', marginBottom: '25px' }}>
        ...
        <StatCard label="Batch Health" value={latest?.health_score} unit="%" icon={<CheckCircle color={latest?.health_score > 85 ? "#4ade80" : "#ef4444"}/>} 
        color={latest?.health_score > 85 ? "#4ade80" : "#ef4444"} />
      </div>
      ...
      <div style={{ display: 'flex', gap: '20px', flex: 1, minHeight: 0 }}>
        ...
        <div style={{ 
          ...
          border: '1px solid #1e293b', flex: 3, display: 'flex', flexDirection: 'column', minHeight: 0 
        }}>
        ...
        <div style={{ background: '#0f172a', padding: '24px', borderRadius: '16px', border: '1px solid #1e293b', flex: 1 }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', marginBottom: '10px', color: '#cbd5e1' }}>Impeller Agitation: {simRpm} RPM</label>
            <input 
